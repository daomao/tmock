...
public class ToStringStyle implements Serializable {
	...
	private static Boolean IfClass = false;
	...
	protected void appendInternal(StringBuffer buffer, String fieldName,
		...
		try {
			if (value instanceof Collection) {
				...
				Object[] objetcs = (Object[]) value;
				for (Object objcet : objetcs) {
					appendValue(buffer, fieldName, objcet, detail);
				}
				...
				appendValue(buffer, fieldName, value, detail);
	...
	private void appendValue(StringBuffer buffer, String fieldName,
			Object value, Boolean detail) {
		if (!(value instanceof Number || value instanceof Boolean
				|| value instanceof Character || value instanceof String || value instanceof Byte)) {
			IfClass = true;
		}
		if (detail) {
	...
	protected void appendDetail(StringBuffer buffer, String fieldName,
		...
		if (!IfClass) {
			...
			// TODO
			IfClass = false;
			buffer.append(StringReflectionBuilder.toString(value));
		}
	}
